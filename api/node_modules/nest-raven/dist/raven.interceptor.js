...
let RavenInterceptor = class RavenInterceptor {
                    ...
                    Sentry.withScope((scope) => {
                        switch (context.getType()) {
                            case 'http':
                                ...
                                return this.captureException(scope, exception, localTransformers);
                            case 'ws':
    ...
    addGraphQLExceptionMetadatas(scope, gqlHost) {
        ...
        const data = node_1.Handlers.parseRequest({}, (context === null || context === void 0 ? void 0 : context.req) || context, this.options);
    ...
    captureException(scope, exception, localTransformers) {
